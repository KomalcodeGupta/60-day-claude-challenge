...
1
Blueprint as Boundary: Only today's Blueprint section gets built — nothing redesigned, nothing from tomorrow started early.
2
Milestone Checkpoints: Each milestone pauses on your screenshot or error report before Claude continues to the next one.
3
Complete Files, No Snippets: Every file Claude generates is the full, final, copy-pasteable version — never a partial diff or TODO.
4
Debug Before Building Further: Any break gets fully resolved before the next milestone starts, so nothing is built on broken code.
